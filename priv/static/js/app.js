...
function update_buttons() {
  (0, _jquery2.default)('.follow-button').each(function (_, bb) {
    var user_id = (0, _jquery2.default)(bb).data('user-id');
    var follow = (0, _jquery2.default)(bb).data('follow');
    if (follow != "") {
      (0, _jquery2.default)(bb).text("Unfollow");
    } else {
      (0, _jquery2.default)(bb).text("Follow");
    }
  });
}
...
function set_button(user_id, value) {
  (0, _jquery2.default)('.follow-button').each(function (_, bb) {
    if (user_id == (0, _jquery2.default)(bb).data('user-id')) {
      (0, _jquery2.default)(bb).data('follow', value);
    }
  });
  update_buttons();
}
...
function follow(user_id) {
  ...
  _jquery2.default.ajax(follow_path, {
    method: "post",
    dataType: "json",
...
function unfollow(user_id, follow_id) {
  _jquery2.default.ajax(follow_path + "/" + follow_id, {
    method: "delete",
    dataType: "json",
    contentType: "application/json; charset=UTF-8",
    data: "",
...
function init_follow() {
  if (!(0, _jquery2.default)('.follow-button')) {
    return;
  }

  (0, _jquery2.default)(".follow-button").click(follow_click);
